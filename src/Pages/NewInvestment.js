    ...
    <>
      ...
      <div className="container">
        ...
        <div className="new-investment-slider">
          ...
          >
            <SwiperSlide>
              <img src={InvestmentImage1} alt="Grand Łeba - nowa inwestycja" />
            </SwiperSlide>

            <SwiperSlide>
              <img src={InvestmentImage2} alt="Grand Łeba - nowa inwestycja" />
            </SwiperSlide>

            <SwiperSlide>
              <img src={InvestmentImage3} alt="Grand Łeba - nowa inwestycja" />
            </SwiperSlide>
          </Swiper>
        </div>
        <p className="text">
          ...
          Rozpościera się stąd fantastyczny widok na Łebę. Będąc naszym gościem
          skorzystasz z dobrodziejstw centrum miasta, jednocześnie czerpiąc
          najlepsze doznania wynikające z umiejscowienia naszego hotelu w
          zaciszu spokojnej ulicy.
          <br />
          <br />
          To zaledwie <strong>6 minut</strong> spacerem do pięknej, piaszczystej
          plaży, <strong>100m</strong> od centralnego placu miasta oraz
        ...
        <div className="new-investment-slider">
          ...
          >
            <SwiperSlide>
              <img src={InvestmentImage4} alt="Grand Łeba - nowa inwestycja" />
            </SwiperSlide>
            <SwiperSlide>
              <img src={InvestmentImage5} alt="Grand Łeba - nowa inwestycja" />
            </SwiperSlide>
          </Swiper>
        </div>
        <p className="text">
          ...
          wyśmienitą kawę - doskonałe dopełnienie pełnego wrażeń dnia spędzonego
